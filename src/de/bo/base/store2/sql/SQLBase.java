...
public abstract class SQLBase implements StoreKeeper, TraceConstants {
    ...
    protected void prepareWhereClause(
        ...
        try {
            if (selection != null)
                for (Iterator it = selection.getValues().iterator(); it.hasNext();) {
    ...
    protected PreparedStatement createQueryStatement(
        ...
        try {
            ...
            PreparedStatement stmt = connection.prepareStatement(sbQuery.toString());
     ...
     */
    public Object[] retrieve(Storable object, Object key) throws StoreException {
        ...
        Object[] data = null;
        SQLSelection sel = new SQLSelection(toolkit, record.getKeyIdentifier(), key);
        // Abfrage anwenden ...
        try {
    ...
    public Collection retrieve(Storable object, Selection selection, String order)
        throws StoreException {
