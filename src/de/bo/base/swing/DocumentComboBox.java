...
/**
 * Diese Klasse stellt eine gew�hnliche JComboBox dar, wobei jedoch der Zugriff
 * auf das JTextField m�glich ist.
...
public class DocumentComboBox<E> extends JComboBox<E> {
   ...
   * @param items Eine Liste von Objekten f�r das Menu der JComboBox
	 **/
   ...
   * JTextFields der JComboBox angeh�ngt werden.
   * @param l Der DocumentListener, der an das Document des JTextFields der
   *		JComboBox angeh�ngt werden soll.
   **/
...
//		return (String) getSelectedItem();
  ...
  /**
   * Diese Methode setzt den Text des JTextFields auf den �bergebenen
   * Parameter.
